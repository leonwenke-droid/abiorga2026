          ...
          <div className="rounded-xl border border-cyan-500/25 bg-card/50 p-5">
            ...
            <ul className="space-y-2 text-xs">
              <li className="flex justify-between items-center">
                ...
                <span className="font-semibold tabular-nums px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-200">
                  {aggregate.total_open}
                </span>
              </li>
              <li className="flex justify-between items-center">
                <span className="text-cyan-300/90">In Arbeit</span>
                <span className="font-semibold tabular-nums px-2 py-0.5 rounded bg-amber-500/20 text-amber-200">
                  {aggregate.total_in_progress}
                </span>
              </li>
              <li className="flex justify-between items-center">
                <span className="text-cyan-300/90">Erledigt</span>
                <span className="font-semibold tabular-nums px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-200">
                  {aggregate.total_completed}
                </span>
              </li>
              <li className="flex justify-between items-center">
                <span className="text-red-300/90">Überfällig</span>
                <span className="font-semibold tabular-nums px-2 py-0.5 rounded bg-red-500/20 text-red-300">
                  {aggregate.total_overdue}
                </span>
              </li>
            </ul>
          </div>
