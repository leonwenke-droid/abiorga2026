      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-10">
          <Link
            ...
            className="mb-4 inline-flex items-center gap-1.5 text-sm text-cyan-400 transition hover:text-cyan-300"
          >
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="flex items-center gap-5 rounded-2xl border border-cyan-500/20 bg-card/80 p-6 shadow-lg shadow-cyan-950/20 backdrop-blur-sm">
              ...
              <div>
                <p className="text-sm font-medium uppercase tracking-wider text-cyan-400/80">Mitglieder</p>
            ...
            <div className="flex items-center gap-5 rounded-2xl border border-cyan-500/20 bg-card/80 p-6 shadow-lg shadow-cyan-950/20 backdrop-blur-sm">
              ...
              <div>
                <p className="text-sm font-medium uppercase tracking-wider text-cyan-400/80">Komitees</p>
            ...
            <div className="flex items-center gap-5 rounded-2xl border border-cyan-500/20 bg-card/80 p-6 shadow-lg shadow-cyan-950/20 backdrop-blur-sm">
              ...
              <div>
                <p className="text-sm font-medium uppercase tracking-wider text-cyan-400/80">Durchschn. Score</p>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Mitglieder</span>
                <p className="text-sm text-cyan-400/80">Verwalten &amp; Import</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Komitees</span>
                <p className="text-sm text-cyan-400/80">Erstellen &amp; Bearbeiten</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Aufgaben</span>
                <p className="text-sm text-cyan-400/80">Kanban &amp; Zuteilung</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Schichten</span>
                <p className="text-sm text-cyan-400/80">Planen &amp; Zuteilen</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Material</span>
                <p className="text-sm text-cyan-400/80">Ressourcen &amp; Events</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Kasse</span>
                <p className="text-sm text-cyan-400/80">Treasury &amp; Upload</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="min-w-0">
                <span className="font-semibold text-cyan-100 group-hover:text-white">Punkte vergeben</span>
                <p className="text-sm text-cyan-400/80">Individuell (Events/Ressourcen)</p>
              </div>
            </Link>
          </div>
        </section>
